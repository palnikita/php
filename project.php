           ...
           //  $sno = $sno+1;
            ...
            echo '<tr>
              ...
              <button class="btn btn-primary"><a href="update1.php?updateid='.$sno.'"
               ...
               <button type="button" class="btn btn-danger"><a href="delete-train.php?deleteid='.$sno.'"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Are you sure want to delete train?
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-success" data-bs-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary"><a href="delete-train.php?deleteid='.$sno.'"
              class="text-light" style="text-decoration:none">Delete</a></button>
            </div>
          </div>
        </div>
